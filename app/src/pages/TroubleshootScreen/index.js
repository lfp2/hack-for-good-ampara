    ...
    <Container>
      ...
      <Section>
        ...
        <Description>
          ...
          página inicial. Se não houver nenhum registro, será necessário efetuar
          o agendamento ou cancelamento da consulta. Caso haja um agendamento
      ...
      <Section>
        ...
        <Description>
          ...
          próximos à sua localidade. Se isso não for possível,
          disponibilizaremos a agenda de outros profissionais para não deixar de
          atendê-lo.
        </Description>
      </Section>
      <Section>
