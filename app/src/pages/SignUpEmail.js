  ...
  return (
    <ScreenCenter>
      ...
      <StyledScrollView>
        ...
        {errors.email && <TextError>Esse campo é obrigatório</TextError>}
        <TextInputView>
        ...
        {errors.password && <TextError>Esse campo é obrigatório</TextError>}
        <TextInputView>
          <InputIcon name="key-variant" />
          <Controller
        ...
        {errors.password_confirmation && (
          <TextError>As senhas não conferem. Tente novamente</TextError>
        )}
      </StyledScrollView>
      <ScreenCenter>
