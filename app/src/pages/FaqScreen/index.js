...
const FaqScreen = () => (
  <Container>
    ...
    <Section>
      ...
      <Description>
        Agentes de saúde, de qualquer parte do Brasil, que estão trabalhando no
        combate ao COVID-19 e precisam de ajuda qualificada para lidar com esse
        cenário atípico e grave no sistema de saúde.
      </Description>
    </Section>
    <Section>
      ...
      <Description>
        ...
        acompanhamento psicológico contínuo, mas sim um apoio pontual durante e
        após a pandemia. As consultas serão realizadas através de ferramentas de
        videoconferência da escolha de ambos profissionais. As diretrizes de
        atendimento terão como base as diretrizes éticas do CFP.
      </Description>
    </Section>
    <Section>
      ...
      <Description>
        ...
        disso, todo profissional de psicologia cadastrado na plataforma aceita o
        Termo de Uso e é orientado pelas diretrizes do projeto. Caso identifique
        alguma conduta incoerente, entre em contato com a equipe do aplicativo
        através do e-mail: hello@amparaapp.com.br
      </Description>
    </Section>
    <Section>
